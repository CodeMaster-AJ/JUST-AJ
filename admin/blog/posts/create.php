...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($title)) {
        ...
        try {
            ...
            // Insert post
            $stmt = $pdo->prepare('INSERT INTO blog_posts (title, slug, content, excerpt, category_id, author_id, status, featured, published_at) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)');
            $stmt->execute([$title, $slug, $content, $excerpt, $category_id, $currentAdmin['id'], $status, $featured, $published_at]);
            ...
            $stmt->execute([$post_id, $seo_title, $seo_description, $seo_keywords, $og_image, $og_title, $og_description, $canonical_url, $index_follow]);
            ...
            <div class="editor-main">
                <div class="form-card">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="slug" name="slug" class="form-input" placeholder="auto-generated-from-title" value="<?php echo $_POST['slug'] ?? ''; ?>">
                        <p class="form-hint">Leave empty to auto-generate from title</p>
                    </div>
                    
                    <div class="form-group">
                        <label for="content" class="form-label">Content *</label>
                        <textarea id="content" name="content" class="form-textarea" style="min-height: 400px;" placeholder="Write your blog content here..."><?php echo $_POST['content'] ?? ''; ?></textarea>
                    </div>
                    
                    <div class="form-group">
                        <label for="excerpt" class="form-label">Excerpt</label>
                        <textarea id="excerpt" name="excerpt" class="form-textarea" style="min-height: 100px;"><?php echo $_POST['excerpt'] ?? ''; ?></textarea>
                        <p class="form-hint">Short summary shown in blog listing (<?php echo getSetting('blog_excerpt_length', 150); ?> characters)</p>
                    </div>
                </div>
            </div>
            ...
            <div class="editor-sidebar">
                <div class="form-card">
                    ...
                    <div class="form-group">
                        ...
                        <input type="datetime-local" id="published_at" name="published_at" class="form-input" value="<?php echo $_POST['published_at'] ?? ''; ?>">
                    </div>
                    
                    <div class="form-group">
                        <label class="form-checkbox">
                            <input type="checkbox" name="featured" value="yes" <?php echo isset($_POST['featured']) ? 'checked' : ''; ?>>
                ...
                <div class="form-card">
                    ...
                    <div class="tags-list">
                        ...
                        <label class="tag-checkbox">
                            <input type="checkbox" name="tags[]" value="<?php echo $tag['id']; ?>" <?php echo isset($_POST['tags']) && in_array($tag['id'], $_POST['tags']) ? 'checked' : ''; ?>>
        ...
        <div class="form-card">
            ...
            <div class="seo-grid">
                <div class="form-group">
                    ...
                    <input type="text" id="seo_title" name="seo_title" class="form-input" maxlength="255" value="<?php echo $_POST['seo_title'] ?? ''; ?>">
                    <p class="form-hint">Title shown in search results (max 60 chars)</p>
                </div>
                
                <div class="form-group">
                    <label for="seo_description" class="form-label">SEO Description</label>
                    <textarea id="seo_description" name="seo_description" class="form-textarea" style="min-height: 80px;" maxlength="320"><?php echo $_POST['seo_description'] ?? ''; ?></textarea>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="seo_keywords" name="seo_keywords" class="form-input" placeholder="keyword1, keyword2, keyword3" value="<?php echo $_POST['seo_keywords'] ?? ''; ?>">
                </div>
                
                <div class="form-group">
                    <label for="canonical_url" class="form-label">Canonical URL</label>
                    <input type="url" id="canonical_url" name="canonical_url" class="form-input" value="<?php echo $_POST['canonical_url'] ?? ''; ?>">
                </div>
                
                <div class="form-group">
                    <label for="index_follow" class="form-label">Index/Follow</label>
                    <select id="index_follow" name="index_follow" class="form-select">
                        <option value="index,follow" <?php echo ($_POST['index_follow'] ?? 'index,follow') === 'index,follow' ? 'selected' : ''; ?>>Index, Follow</option>
                        <option value="index,nofollow" <?php echo ($_POST['index_follow'] ?? '') === 'index,nofollow' ? 'selected' : ''; ?>>Index, NoFollow</option>
                        <option value="noindex,follow" <?php echo ($_POST['index_follow'] ?? '') === 'noindex,follow' ? 'selected' : ''; ?>>NoIndex, Follow</option>
                        <option value="noindex,nofollow" <?php echo ($_POST['index_follow'] ?? '') === 'noindex,nofollow' ? 'selected' : ''; ?>>NoIndex, NoFollow</option>
                    </select>
                </div>
            </div>
        </div>
        ...
        <div class="form-card">
            ...
            <div class="seo-grid">
                <div class="form-group">
                    ...
                    <input type="text" id="og_title" name="og_title" class="form-input" maxlength="255" value="<?php echo $_POST['og_title'] ?? ''; ?>">
                </div>
                
                <div class="form-group">
                    <label for="og_description" class="form-label">OG Description</label>
                    <textarea id="og_description" name="og_description" class="form-textarea" style="min-height: 80px;"><?php echo $_POST['og_description'] ?? ''; ?></textarea>
                </div>
                
                <div class="form-group">
                    <label for="og_image" class="form-label">OG Image URL</label>
                    <input type="url" id="og_image" name="og_image" class="form-input" value="<?php echo $_POST['og_image'] ?? ''; ?>">
